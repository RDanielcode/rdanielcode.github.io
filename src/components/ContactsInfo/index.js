...
import { Button, CapitalLetter, Contact, Container, Form, InputContent, InputTitle, Label, Social, Title } from './styles'
  ...
  return (
    <Container>
      ...
      <Form action='https://formsubmit.co/danielalejndro@gmail.com' method='POST' id='Contact'>
        ...
        <InputTitle type='text' placeholder='Jhon Doe' name='name' />

        <Label htmlFor='email'>Email</Label>
        <InputTitle type='text' placeholder='jhondoe@gmail.com' name='email' />

        <Label htmlFor='about'>About</Label>
        <InputTitle type='text' placeholder='Topic' name='about' />
